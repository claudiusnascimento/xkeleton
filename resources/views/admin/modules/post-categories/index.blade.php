...
<x-admin.page-title :title="'Categorias de Post'" />
            ...
            <div class="x_content">
                ...
                <div class="x_body">
                    ...
                    <div class="x_panel_header">
                        <div class="row">
                            <div class="col-sm-6">
                                <x-admin.panel-title :title="'Listagem de Categorias de Post'" />
                            </div>
                            <div class="col-sm-6 text-right">
                                <a href="{{ route($wildcard . '.create') }}" class="btn btn-success">Criar Categoria</a>
                            </div>
                        </div>
                    </div>
