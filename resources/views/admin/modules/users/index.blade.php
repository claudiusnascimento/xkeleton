...
<x-admin.page-title :title="'Usuários'" />
			...
			<div class="x_content">
				...
				<div class="x_body">
                    ...
                    <div class="x_panel_header">
                        <div class="row">
                            <div class="col-sm-6">
                                <x-admin.panel-title :title="'Listagem de usuários'" />
                            </div>
                            <div class="col-sm-6 text-right">
                                <a href="{{ route($wildcard . '.create') }}" class="btn btn-success">Criar Usuário</a>
                            </div>
                        </div>
                    </div>
									...
									@foreach($models as $model)
										...
										<tr class="{{ ($loop->even ? 'even' : 'odd') . ' pointer' }}">
											...
											<td class="a-right a-right ">
												<a href="{!! $model->link() !!}"><i class="fa fa-edit"></i></a>
                                                &nbsp;|&nbsp;
